...
//     const normalized = rate / 20; // convert 20–100 to 1–5
//     setValue("courseRating", normalized);
//     trigger("courseRating"); // manually trigger validation
//   };
...
//               </label>
//               <Rating
//                 onClick={(rate) => setValue("courseRating", rate / 20, { shouldValidate: true })}
//                 ratingValue={rating * 20} // convert 1–5 to 20–100 scale
//                 size={24}
//                 label
//                 transition
//                 fillColor="#ffd700"
